...
const requiredStaticFiles=['index.html','styles.css','qa/device.html','qa/device.css','qa/device.js','qa/share-card.html','qa/share-card.js','docs/MASTER_SPEC.md','docs/evidence/DEVICE_QA_TEMPLATE.md','.github/workflows/qa.yml','scripts/browser_tests.mjs','scripts/cross_browser_tests.mjs','package-lock.json'];
