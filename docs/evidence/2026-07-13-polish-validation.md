...
- GitHub Actions `static-validation` passed in 11 seconds on draft PR #1 ([run 29226230002](https://github.com/Mini-Tech-Meetup/IHFK/actions/runs/29226230002)); it executes the same `npm run check` gate on every PR and `main` push.
