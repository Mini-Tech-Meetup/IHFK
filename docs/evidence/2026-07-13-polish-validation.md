...
- GitHub Actions `static-validation` passed in 58 seconds on draft PR #1 ([run 29226812637](https://github.com/Mini-Tech-Meetup/IHFK/actions/runs/29226812637)); it executes `npm run check` plus the five-group Chromium browser/responsive suite on every PR and `main` push.
