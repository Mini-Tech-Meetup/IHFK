...
- GitHub Pages configuration: `built`, HTTPS enforced, source `main` at `/`, public URL `https://mini-tech-meetup.github.io/IHFK/`. The live page still serves the pre-refactor title (`I Hate FXXKing Kiosk`); this worktree has intentionally not been committed, pushed or merged by the implementation pass.
