...
## 사용자 동작
컷신 이후 빠르고 어설픈 록을 들으며 투박한 픽셀 배경과 강한 타격·파괴 효과를 경험하고 M 또는 터치 아이콘으로 음소거한다.

## 기술 설계
배경은 270×160/16색 원본을 nearest-neighbor 4× 확대한다. WebAudio oscillator/sequencer가 MIDI풍 루프와 합성 효과음을 생성한다.
