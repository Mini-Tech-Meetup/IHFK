...
## 테스트
- [x] 자동: 잔량 추가·상한·소모·주먹 복귀, 전방 1대 선택, 78×58 공격 영역, 무기 스케일 2.5, 픽업 중심 정렬
...
- 성능 수치: fist 100ms, 78×58 at x+18/y-60; bat 180ms, chainsaw 50ms, shotgun 250ms; player 42×88; base/weapon visible-height normalization ≈115px
