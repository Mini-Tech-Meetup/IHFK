...
## 테스트
- [x] 자동: `npm run check`, browser 29/29, E2E
- [x] 데스크톱: 로컬 HTTP와 Pages-equivalent 경로
- [ ] 모바일: Android/iOS fullscreen·orientation·share
- [x] 시각 검수: 844×390 FIT와 touch HUD

## 증거
- 명령 및 결과: `npm run check`; browser 29/29; 10/10 locale containment; accelerated campaign→Result→Endless; Result PNG fallback; exact 1080×640 title/guide/FastFood/stress/result captures; GitHub Actions [static-validation PASS](https://github.com/Mini-Tech-Meetup/IHFK/actions/runs/29226230002) in 11s
