...
## 테스트
- [x] 자동: 타이머 freeze·locale-preserving reset
...
- 스크린샷: 22-frame transform and Intro/FastFood smoke
- 성능 수치: transform animation positions 1–22 only; first auto destruction exactly once
