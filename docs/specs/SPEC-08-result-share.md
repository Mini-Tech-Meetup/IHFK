...
## 테스트
- [x] 자동: 1080×640 Canvas·PNG 다운로드 폴백·정상/최종 파손 키오스크 텍스처·버튼 비중첩
- [x] 데스크톱: Result/Retry/Keep Breaking
- [ ] 모바일: native file share sheet
- [x] 시각 검수: 결과 화면과 카드 구성

## 증거
- 명령 및 결과: 단위 PNG fallback PASS; 실제 Result 공유 동작 `downloaded` 반환; 화면 preview natural size 1080×640; 세 버튼이 공유 이미지 아래에 있음을 E2E 실측
- 스크린샷: [공유 PNG 원본](../evidence/runtime-result-share-surface-1080x640.png), [버튼이 분리된 실제 Result](../evidence/runtime-result-share-surface-screen-1080x640.png)
