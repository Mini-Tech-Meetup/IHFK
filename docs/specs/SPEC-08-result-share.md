...
- 스크린샷: [1080×640 Result](../evidence/runtime-result-1080x640.png)
- 성능 수치: card 1080×1080 PNG; 로드된 strong character/factory rasters 사용 검사 PASS
