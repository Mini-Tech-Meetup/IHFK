...
const [character,factory,wreck,kioskIntact,kioskBroken]=await Promise.all([
  ...
  load('../assets/kiosk/frames-v2/01.png'),
  load('../assets/kiosk/frames-v2/05.png')
]);
const sources={'strong-attack':character,'bg-factory':factory,'factory-v2-4':wreck,'kiosk-v2-0':kioskIntact,'kiosk-v2-4':kioskBroken};
